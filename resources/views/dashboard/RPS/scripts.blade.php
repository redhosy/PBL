...
$(document).ready(function() {
    ...
    function clearErrorMsg() {
        $('#koderps').removeClass('is-invalid');
        $('#error_koderps').html('');

        $('#kode_matkul').removeClass('is-invalid');
        $('#error_kode_matkul').html('');

        $('#versi').removeClass('is-invalid');
        $('#error_versi').html('');
    ...
    $('#saveRps').on('click', function() {
        ...
        $.ajax({
            ...
            error: function(errors) {
                ...
                if (error.koderps) {
                    $('#koderps').addClass('is-invalid');
                    $('#error_koderps').html(`<div class="text-danger">${error.koderps}</div>`);
                }
                ...
                if (error.versi) {
                    $('#versi').addClass('is-invalid');
                    $('#error_versi').html(`<div class="text-danger">${error.versi}</div>`);
                }
