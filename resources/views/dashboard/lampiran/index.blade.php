...
@section('title', 'Lampiran berita acara RPS & Soal')

@section('scriptpages')
    @include('dashboard.lampiran.scripts')
@endsection
...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body p-3 rounded">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="dataTable1" class="display">
    ...
    @include('dashboard.lampiran.addModal')
    @include('dashboard.lampiran.editModal')
