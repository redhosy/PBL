<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.editBtn', function() {
            ...
            $.get("/beritaRPS/" + dataId + "/edit", function(response) {
                console.log(response);
                $('#editsemester').selectpicker('val', response.data.semester);
                $('#editmatakuliah').selectpicker('val', response.data.id_matakuliah); // Sesuaikan ini dengan struktur data Anda
