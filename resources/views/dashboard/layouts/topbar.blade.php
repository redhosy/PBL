        ...
        @can('dosen-pengampu')
            <li class="dropdown dropdown-list-toggle">
              <a href="#" data-toggle="dropdown"
                    class="nav-link notification-toggle nav-link-lg beep"><i class="far fa-bell"></i>
                  </a>
            ...
            <a href="#" data-toggle="dropdown"
                ...
                <div class="rounded-circle overflow-hidden" style="width: 30px; height: 30px;">
                    @if (Auth::user()->profile_photo_path)
                        <img alt="image" src="{{ asset('storage/' . Auth::user()->profile_photo_path) }}"
                            class="w-100 h-100 rounded-circle" style="object-fit: cover;">
                    @else
                        <img alt="image"
                            src="{{ Auth::user()->avatar ?? 'https://ui-avatars.com/api/?name=' . Auth::user()->name . '&background=f666b5&color=ffffff&size=150' }}"
                            class="w-100 h-100 rounded-circle" style="object-fit: cover;">
                    @endif
                </div>
