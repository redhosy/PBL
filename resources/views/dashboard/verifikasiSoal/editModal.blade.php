            ...
            <form id="editBeritaAcaraForm">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control selectpicker w-100" id="edit_semester" name="semester">
                    ...
                    <div class="form-group">
                        <label for="edit_matakuliah">Matakuliah:</label>
                        <div class="selectpicker">
                            <select data-live-search="true" class="form-control w-100" id="edit_matakuliah" name="matakuliah">
                    ...
                    <div class="form-group">
                        <label for="edit_validasiisi">Validasi Isi:</label>
                        <textarea class="form-control" id="edit_validasiisi" name="validasiisi" rows="3"></textarea>
                    </div>
