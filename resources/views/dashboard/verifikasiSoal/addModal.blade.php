        ...
        <div class="modal-content">
            <form id="addPostForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="validasiisi">Validasi Isi:</label>
                        <textarea class="form-control" id="evaluasi" name="validasiisi" rows="3"></textarea>
                        <span id="error_validasiisi" class="text-danger"></span>
                    </div>
